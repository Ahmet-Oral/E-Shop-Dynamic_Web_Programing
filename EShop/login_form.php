...
#if below statment return true then we will send user to their homePageAdmin.php page
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			...
			<ul class="nav navbar-nav">
				<li><a href="homePageGuest.php"><span class="glyphicon glyphicon-home"></span>Home</a></li>
				<li><a href="homePageGuest.php"><span class="glyphicon glyphicon-modal-window"></span>Product</a></li>
			</ul>
		</div>
	</div>
	<p><br/></p>
